...
Σήμερα το android είναι το πιο διαδεδομένο λειτουργικό σύστημα στον κόσμο με πάνω από 2.5 δισσεκατομμύρια συσκευές (2019). Υπάρχει μεγάλη γκάμα εφαρμογών διαθέσιμες για πολλές διαφορετικές χρήσεις. Ιδιαίτερα στο περιβάλλον του διάχυτου υπολογισμού και του έξυπνου σπιτιού αναπτύσονται συνεχώς εφαρμογές που εκμεταλλεύονται την πληθώρα δεδομένων που συλλέγουν οι έξυπνες συσκευές. Η ύπαρξη ενιαίας πλατφόρμας ανάπτυξης εφαρμογών για ένα μεγάλο μέρος των κινητών συσκευών παγκοσμίως βοήθησε την ανάπτυξη χιλιάδων εφαρμογών που έχουν αλλάξει τον τρόπο της διάδρασης των χρηστών με τα υπολογιστικά συστήματα. Η συνεισφορά του android σ' αυτό το νέο υπόδειγμα διάδρασης είναι κομβική.  
